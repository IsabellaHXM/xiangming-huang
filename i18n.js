...
const I18N_ZH = {
  ...
  'research.label': '研究方向',
  'research.qtag': '研究问题',
  'research.q': '人人都在谈论的「AI-native」究竟是什么？在共享的大模型底座上，创始人如何构建公司的独特性——又如何面向不同的受众，调整自己的叙事？',
  ...
  'research.scope': '15+ 家 AI-native 公司——从 AI 交易、企业级 AI 员工，到 AI 宠物陪伴、AI 占卜。1,000+ 分钟创始人深度访谈，覆盖 Bootstrapped 至 A 轮，中国、美国、欧洲与香港市场。',
...
const I18N_EN = {
  ...
  'research.label': 'Research Interests',
  'research.qtag': 'Research Question',
  'research.q': 'What is this "AI-native" everyone keeps talking about? When every venture builds on the same foundation models, how do founders construct distinctiveness — and how does the story change with the audience?',
  ...
  'research.scope': '15+ AI-native ventures — from AI trading and enterprise AI workers to AI pet companions and AI divination. 1,000+ minutes of founder interviews, bootstrapped to Series A, across China, the US, Europe and Hong Kong.',
