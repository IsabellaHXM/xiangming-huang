...
const I18N_ZH = {
  ...
  'about.p2': '目前，我在伦敦 <em><a href="https://www.tiktok.com" target="_blank" rel="noopener">TikTok</a></em> 做平台策略与商家体验分析。此前，我在 <em><a href="https://www.merckgroup.com" target="_blank" rel="noopener">Merck</a></em> 做渠道定价与业务诊断，在 <em><a href="http://huagaicapital.com" target="_blank" rel="noopener">华盖资本</a></em> 和 <em><a href="https://www.csc108.com" target="_blank" rel="noopener">中信建投</a></em> 做投研分析，在 <em><a href="https://www.accenture.com" target="_blank" rel="noopener">Accenture</a></em> 做战略咨询。',
  ...
  'case.tt.stats': '15,000+ 笔订单样本 · 3 类逆向流程端到端拆解 · 定位 367 个潜在争议订单',
  ...
  'case.tt.a1': '基于 15,000+ 笔拍卖售后订单（8,000+ cancellation / 3,000+ refund-only / 4,000+ return & refund），对三类逆向流程做端到端拆解，覆盖审核、自动审批、平台仲裁、卖家申诉与赔付全链路。',
  'case.tt.a1.strategy': '基于 15,000+ 笔拍卖售后订单（8,000+ cancellation / 3,000+ refund-only / 4,000+ return & refund），对三类逆向流程做端到端拆解，覆盖审核、自动审批、平台仲裁、卖家申诉与赔付全链路。',
  'case.tt.a1.product': '把审核、自动审批、平台仲裁、卖家申诉与赔付看作一条产品链路，在 15,000+ 笔订单样本上定位体验断点与决策不透明的场景。',
  'case.tt.a2': '通过路径分析与 case review 验证新政策的实际效果，在 refund-only 场景定位 367 个潜在争议订单与仍存在体验争议的场景。',
  ...
  'case.mk.stats': 'SQL 清洗 × Python 爬虫双源采集 · 跨省可比价格数据库 · 医院 / 零售 / 社区 / 县域 4 类渠道',
  ...
  'case.hg.stats': '23 场实地访谈 · 18 份纪要 · 7 次专家访谈 · 5 年财务预测模型',
  ...
  'research.method': '对 15 位 AI-native 创始人进行半结构化深度访谈，结合 pitch deck、官网与媒体报道做企业材料分析；主题编码，跨案例比较。',
  ...
  'fw.4.name': '独特性是动态的',
  'fw.4.desc': '能持久的不是某一个优势，而是被相信能持续生成新优势：快跑、迭代、为三个月后的智能构建。论文把它叫 dynamic distinctiveness。',
  ...
  'research.charls.role': '调查员 · 两篇实证研究',
...
const I18N_EN = {
  ...
  'about.p2': 'Currently, I work on platform strategy and seller-experience analytics at <em><a href="https://www.tiktok.com" target="_blank" rel="noopener">TikTok</a></em> in London. Previously, I worked on channel pricing and business diagnostics at <em><a href="https://www.merckgroup.com" target="_blank" rel="noopener">Merck</a></em>, investment research at <em><a href="http://huagaicapital.com" target="_blank" rel="noopener">Huagai Capital</a></em> and <em><a href="https://www.csc108.com" target="_blank" rel="noopener">CSC Financial</a></em>, and strategy consulting at <em><a href="https://www.accenture.com" target="_blank" rel="noopener">Accenture</a></em>.',
  ...
  'case.tt.stats': '15,000+ order sample · 3 reverse flows mapped end to end · 367 potential dispute orders located',
  ...
  'case.tt.a1': 'Mapped all three reverse flows end to end across 15,000+ auction aftersale orders (8,000+ cancellation / 3,000+ refund-only / 4,000+ return & refund), covering review, auto-approval, platform arbitration, seller appeal and compensation.',
  'case.tt.a1.strategy': 'Mapped all three reverse flows end to end across 15,000+ auction aftersale orders (8,000+ cancellation / 3,000+ refund-only / 4,000+ return & refund), covering review, auto-approval, platform arbitration, seller appeal and compensation.',
  ...
  'case.tt.a2': 'Path analysis and case review validated the policy\'s actual effect, locating 367 potential dispute orders in the refund-only flow alongside the scenarios where seller-experience disputes persisted.',
  ...
  'case.mk.stats': 'SQL cleaning × Python scraping · cross-province comparable-price database · 4 channel types: hospital / retail / community / county',
  ...
  'case.hg.stats': '23 site interviews · 18 memos · 7 expert consultations · 5-year financial model',
  ...
  'research.method': 'Semi-structured interviews with 15 AI-native founders, triangulated with venture materials — pitch decks, websites, press coverage; thematic coding and cross-case comparison.',
  ...
  'fw.4.desc': 'What endures is not any single advantage but the credible capacity to keep generating new ones — speed, iteration, building for the intelligence three months out. The dissertation calls this dynamic distinctiveness.',
  ...
  'research.charls.role': 'Survey researcher · two empirical studies',
